...
class TransH(nn.Module):
    def __init__(self, hentityemb, tentityemb, HentityNum, TentityNum, relationNum=5, embeddingDim=64, margin=1.0, L=2, C=1.0, eps=0.001):
        ...
        self.relationEmbedding = nn.Embedding(num_embeddings=relationNum+1,
    ...
    def forward(self, posX, negX):
        ...
        return  marginLoss/size +self.C*(HentityLoss/self.Hentnum + TentityLoss/self.Tentnum + orthLoss/self.relnum)
